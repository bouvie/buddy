...
export const Default: Story = {
  render: (args) => ({
    props: args,
    template: `<app-empty-state ${argsToTemplate(args)}></app-empty-state>`,
  }),
};
    ...
    template: `
      <div style="display:flex;flex-direction:column;gap:32px;background:var(--k9-color-bg)">
        <div style="border:1px solid var(--k9-color-border);border-radius:16px">
          <app-empty-state size="sm" title="Small" description="Vue compacte."></app-empty-state>
        </div>
        <div style="border:1px solid var(--k9-color-border);border-radius:16px">
          <app-empty-state size="md" title="Medium" description="Vue standard." actionLabel="Ajouter"></app-empty-state>
        </div>
        <div style="border:1px solid var(--k9-color-border);border-radius:16px">
          <app-empty-state size="lg" title="Large" description="Vue ample pour page dédiée." actionLabel="Commencer"></app-empty-state>
        </div>
      </div>
    `,
  }),
